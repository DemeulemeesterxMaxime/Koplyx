...
cp -R assets bin docs koplyx packaging scripts CHANGELOG.md CODE_OF_CONDUCT.md CONTRIBUTING.md LICENSE README.md SECURITY.md VERSION "$DEB_ROOT/opt/koplyx/"
...
Recommends: gnome-shell-extension-appindicator, wtype
